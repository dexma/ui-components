...
export declare const SwitchPeriodComparative: ({ selectedPeriod, startDate, endDate, previousPeriodText, samePeriodLastYearText, onPeriodSelect, ...props }: SwitchPeriodComparativeProps) => import("react/jsx-runtime").JSX.Element;
export {};
