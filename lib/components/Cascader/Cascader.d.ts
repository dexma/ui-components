...
export declare const Cascader: <OptionType extends DefaultOptionType>({ multiple, options, maxTagCount, onChange, open, changeOnSelect, ...props }: CascaderProps<OptionType>) => import("react/jsx-runtime").JSX.Element;
export {};
