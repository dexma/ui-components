...
export declare const AntdDatePicker: React.ForwardRefExoticComponent<(AntdDatePickerProps & {
    dataId?: string;
}) & React.RefAttributes<unknown>>;
export type AntdRangePickerProps = RangePickerProps & CommonProps;
export declare const AntdRangePicker: React.ForwardRefExoticComponent<(AntdRangePickerProps & {
    dataId?: string;
}) & React.RefAttributes<unknown>>;
type DatePickerType = {
    type: 'date' | 'range';
