...
export declare const ButtonPaginationSelector: ({ handleSelectAll, pageSize, currentPage, options, onPageChange, text, theme, searchValue, showDropdown, }: ButtonPaginationSelectorProps) => import("react/jsx-runtime").JSX.Element;
export {};
