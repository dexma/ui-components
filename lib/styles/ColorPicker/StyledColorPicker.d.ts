...
declare const StyledColorPickerInput: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<Omit<Omit<Omit<{
    placeholder?: string;
    id?: string;
    icon?: string;
    ...
    disabled?: boolean;
    dataId?: string;
} & import('../../../../node_modules/react').InputHTMLAttributes<HTMLInputElement> & import('../../../../node_modules/react').RefAttributes<HTMLInputElement>, "dataId"> & Partial<{
    dataId?: string;
...
}, never>> & string & Omit<import('../../../../node_modules/react').ForwardRefExoticComponent<Omit<Omit<{
    placeholder?: string;
    id?: string;
    icon?: string;
    label?: string | import('../../../../node_modules/react').ReactNode;
